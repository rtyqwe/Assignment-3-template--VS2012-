...
{
	Tcl_CreateCommand(interp, "system",(Tcl_CmdProc*)  Command, (ClientData) NULL,
		(Tcl_CmdDeleteProc *)	NULL);
	Tcl_CreateCommand(interp, "simulator",(Tcl_CmdProc*)  Command, (ClientData) NULL,
		(Tcl_CmdDeleteProc *)	NULL);
	Tcl_CreateCommand(interp, "show",(Tcl_CmdProc*)  Command, (ClientData) NULL,
		(Tcl_CmdDeleteProc *)	NULL);
