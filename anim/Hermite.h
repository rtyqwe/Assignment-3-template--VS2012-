...
private:
	...
	// commands
	int				_cmd_setPoint(int argc, char **argv);
	int				_cmd_setTangent(int argc, char **argv);
	int				_cmd_setTangentVisibility(int argc, char **argv);
	int				_cmd_setControlPointVisibility(int argc, char **argv);
	int				_cmd_setSelectedPointVisibility(int argc, char **argv);
	int				_cmd_setSelectedValue(int argc, char **argv);
	int				_cmd_setStartingArclength(int argc, char **argv);
	int				_cmd_addPoint(int argc, char **argv);
	int				_cmd_getArcLengthTable(int argc, char **argv);
	int				_cmd_getArcLengthFromT(int argc, char **argv);
	int				_cmd_getTFromArcLength(int argc, char **argv);
	int				_cmd_load3D(int argc, char **argv);
	int				_cmd_load2D(int argc, char **argv);
	int				_cmd_export(int argc, char **argv);
	int				_cmd_reset(int argc, char **argv);
