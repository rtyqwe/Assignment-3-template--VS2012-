...
int Hermite::command(int argc, char **argv)
{
	int returnCode = -1;
	...
	{
		animTcl::OutputMessage("Hermite:: unknown command\n");
		return TCL_ERROR;
	}
...
int	Hermite::_cmd_setPoint(int argc, char **argv)
{
...
int	Hermite::_cmd_setTangent(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 4);
...
int	Hermite::_cmd_setSelectedValue(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_setTangentVisibility(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_setControlPointVisibility(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_setSelectedPointVisibility(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_addPoint(int argc, char **argv)
{
...
int	Hermite::_cmd_getArcLengthTable(int argc, char **argv)
{
	printTableArcLength();
	return TCL_OK;
...
int	Hermite::_cmd_getArcLengthFromT(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int Hermite::_cmd_getTFromArcLength(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_load3D(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_load2D(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int	Hermite::_cmd_export(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
...
int Hermite::_cmd_reset(int argc, char **argv)
{
	reset();
...
int	Hermite::_cmd_setStartingArclength(int argc, char **argv)
{
	CHECK_NUM_ARGS(argc, 1);
